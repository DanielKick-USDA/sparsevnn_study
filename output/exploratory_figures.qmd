...
#   p <- (p_top + p_bot)+plot_layout(design = design)
  ...
  p <- tmp_all |>
    ggplot(aes(x = init, y = mse, fill = split))+
    geom_hline(
      yintercept = as.numeric(select(filter(tmp_best, split == 'Train'), mse)), 
      color = 'cornflowerblue', linetype = 'dashed'
    )+
    geom_hline(
      yintercept = as.numeric(select(filter(tmp_best, split == 'Validation'), mse)),
...
map(xx$phn, function(e){
  ...
  ggsave(paste0('paper_1mods_5cor_data_', kegg,'-',e, '.svg'), p[[1]], width = 7, height = 7, units = 'in')
  ggsave(paste0('paper_1mods_5cor_data_', kegg,'-',e, '.png'), p[[1]], width = 7, height = 7, units = 'in')
  
  ggsave(paste0('paper_1mods_6rho_data_', kegg,'-',e, '.svg'), p[[2]], width = 7, height = 7, units = 'in')
  ggsave(paste0('paper_1mods_6rho_data_', kegg,'-',e, '.png'), p[[2]], width = 7, height = 7, units = 'in')
...
p+coord_cartesian(ylim = c(6975,7000))

p+coord_cartesian(ylim = c(5000,7000))
