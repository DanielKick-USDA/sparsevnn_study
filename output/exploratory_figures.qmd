...
xx <- list(
  c("dnn", paste0(xx_exp, ''),           "phno_all_Pollen_GDD__FTaxaREnvRGxE", "DNN Tanh"),
  c("vnn", paste0(xx_exp, ''),           "phno_all_Pollen_GDD__FTaxaREnvRGxE", "VNN Tanh"),
  c("vnn", paste0(xx_exp, '_lsuv_relu'), "phno_all_Pollen_GDD__FTaxaREnvRGxE", "VNN Tanh LSUV"),
  c("vnn", paste0(xx_exp, '_lsuv_tanh'), "phno_all_Pollen_GDD__FTaxaREnvRGxE", "VNN Relu LSUV"), 
  c("vnn", paste0(xx_exp, '_lsuv_vlin'), "phno_all_Pollen_GDD__FTaxaREnvRGxE", "VLN LSUV") 
  )
plt_list <- map(seq_along(xx), function(i){
  plt <- plt_hyps(
    df = filter(
